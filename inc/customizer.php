...
Action::add('customize_register', 'twentynineteen_customize_register');
...
{
    wp_enqueue_script('twentynineteen-customize-preview', get_theme_file_uri('dist/js/customize-preview.js'),
        array('customize-preview'), '20181231', true);
}

Action::add('customize_preview_init', 'twentynineteen_customize_preview_js');
...
{
    wp_enqueue_script('twentynineteen-customize-controls', get_theme_file_uri('dist/js/customize-controls.js'), array(),
        '20181231', true);
}

Action::add('customize_controls_enqueue_scripts', 'twentynineteen_panels_js');
