...
Filter::add('body_class', 'twentynineteen_body_classes');
...
Filter::add('post_class', 'twentynineteen_post_classes', 10, 3);
...
Action::add('wp_head', 'twentynineteen_pingback_header');
...
Filter::add('comment_form_defaults', 'twentynineteen_comment_form_defaults');
...
{
    if (is_category()) {
        $title = __('Category Archives: ', 'twentynineteen') . '<span class="page-description">' . single_term_title('',
                false) . '</span>';
    } elseif (is_tag()) {
        ...
        $title = __('Yearly Archives: ', 'twentynineteen') . '<span class="page-description">' . get_the_date(_x('Y',
                'yearly archives date format', 'twentynineteen')) . '</span>';
    } elseif (is_month()) {
        $title = __('Monthly Archives: ', 'twentynineteen') . '<span class="page-description">' . get_the_date(_x('F Y',
        ...
        $title = __('Post Type Archives: ',
                'twentynineteen') . '<span class="page-description">' . post_type_archive_title('', false) . '</span>';
    } elseif (is_tax()) {
...
Filter::add('get_the_archive_title', 'twentynineteen_get_the_archive_title');
...
Filter::add('wp_get_attachment_image_attributes', 'twentynineteen_post_thumbnail_sizes_attr', 10, 1);
...
Filter::add('wp_nav_menu', 'twentynineteen_add_ellipses_to_nav', 10, 2);
...
Filter::add('nav_menu_link_attributes', 'twentynineteen_nav_menu_link_attributes', 10, 4);
...
Filter::add('walker_nav_menu_start_el', 'twentynineteen_add_dropdown_icons', 10, 4);
...
Filter::add('wp_nav_menu_objects', 'twentynineteen_add_mobile_parent_nav_menu_items', 10, 2);
