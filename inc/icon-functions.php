...
{
    return \Theme\Support\TwentyNineteen_SVG_Icons::get_svg('ui', $icon, $size);
}
...
{
    return \Theme\Support\TwentyNineteen_SVG_Icons::get_svg('social', $icon, $size);
}
...
{
    return \Theme\Support\TwentyNineteen_SVG_Icons::get_social_link_svg($uri, $size);
}
